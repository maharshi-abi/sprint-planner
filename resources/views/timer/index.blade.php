...
@if($activeSession)
<div class="bg-indigo-50 dark:bg-slate-800 border-2 border-indigo-200 dark:border-slate-700 rounded-2xl p-6 mb-8 shadow-sm">
...
<div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm max-w-2xl">
    <p class="text-sm text-slate-600 dark:text-slate-400 mb-4">Workflow: Select Sprint → Task → Category → Description → Start Timer</p>
...
async function refreshTimer() {
    ...
    if (data.active) {
        ...
        // Loop the ring every 60 seconds
